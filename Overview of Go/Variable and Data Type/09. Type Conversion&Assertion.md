...
Proses akan dievaluasi saat compile, sehingga akan menghasilkan error jika tipe tidak diketahui/`any`.
...
Digunakan untuk mengecek seubah tipe data. Terima `ok`, agar program tidak `panic`.
